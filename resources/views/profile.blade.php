            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            @if($user->photo)
                                <img src="{{ asset('storage/photos/'.$user->photo) }}" class="img-thumbnail rounded mx-auto d-block" alt="Profile Photo">
                            @else
                    ...
                    @if (Auth::user()->role === 'konselor')
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">{{ __('Daftar Spesialis') }}</div>
                                    <div class="card-body">
                                        @if ($spesialis->isNotEmpty())
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">ID</th>
